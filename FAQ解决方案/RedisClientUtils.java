...
public class RedisClientUtils {
    ...
    { 
        ...
        shards.add(new JedisShardInfo("127.0.0.1", 6379, "guolei")); 
    ...
    private void KeyOperate() {
     ...
     private void ListOperate() {
         ...
         System.out.println("所有元素-stringlists："+shardedJedis.lrange("stringlists", 0, -1));//0开始正数表示开始第几个元素  -1表示最后一个元素  -2表示倒数第二个元素 以此类推
         ...
         // 列表元素出栈 
         System.out.println("出栈元素："+shardedJedis.lpop("stringlists")); //移除并返回栈顶元素值
     ...
     //zset就是set的强化，增加了一个标识顺序的,  sorted set是set的一个升级版本,它在set的基础上增加了一个顺序属性,这一属性在添加修改元素的时候可以指定,
     ...
     private void SortedSetOperate() {
          ...
          System.out.println("=============增=============");
          System.out.println("zset中添加元素element001："+shardedJedis.zadd("zset", 7.0, "element001")); //表示增加顺序号为7.0的元素element001
